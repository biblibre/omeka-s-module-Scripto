...
![Scripto module configuration page, with the field empty and highlighted in red](images/scripto-configure.png)
...
### Scripto Vocabulary
Once Scripto is installed and active, it will add the Scripto [Vocabulary](https://omeka.org/s/docs/user-manual/content/vocabularies/) to your Omeka S installation. This vocabulary contains the following properties:
...
## Create an item set
The Scripto module uses [item sets](https://omeka.org/s/docs/user-manual/content/item-sets/) to manage the content coming to and from your Omeka installation.
...
![Scripto dashboard header and log in fields](images/scripto-dash-login.png)
...
![Scripto dashboard with three projects, two of which the user reviews, and a series of recent contributions.](images/scripto_dash.png)
...
![Dropdown showing the options to browse projects, add a project, or browse users](images/scripto-dash-actions.png)
...
![Browse users table with two users, one regular and one admin](images/scripto-browseUsers.png)
...
![Contributions of the user DemoUser - one edit dated 15 October 2019](images/scripto-user-contributions.png)
