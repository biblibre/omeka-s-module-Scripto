...
![Action dropdown open with a red arrow pointing to the Add New Project option](images/scripto-projectAdd.png)
...
![Just the top of new project page, showing the two tabs and the eye symbol](images/scripto-projectAdd2.png)
...
![Add New Project window open to the "Configuration" tab - all fields are blank](images/scripto-projectNewConfig.png)
...
![Guidelines editor in action, displaying editor](images/scripto-projectGuideEdit.png)
...
### Reviewers
Add [Omeka S users](https://omeka.org/s/docs/user-manual/admin/users/) to your Scripto project as reviewers, who can can access private projects, and mark media as approved and unapproved. You can manage users after adding a project (see below).
...
![Add New Project window open to the "Reviewers" tab - the page is largely blank, with an alphabetical menu down one side.](images/scripto_newrev.png)
...
![New project sync message](images/scripto-newproject.png)
...
![](images/scripto-projectactions.png)
...
![scripto review page, user not logged in to Scripto](images/scripto-admin-project1.png)
...
![item admin side with drawer open](images/scripto-itemview.png)
...
![batch edit](images/scripto_batcheditmedia.png)
...
![Omeka item metadata view](images/scripto-omekaitemmeta.png)
...
![Media review](images/scripto_mediareview1.png)
...
![This revision section showing an old revision](images/scripto-thisrevold.png)
...
![Revision history](images/scripto_revisionhist.png)
...
![a red arrow points to the "View notes" button in a close-up of the upper right hand corner](images/scripto_notes_loc.png)
...
![Notes](images/scripto_notes.png)
...
![Actions dropdown](images/scripto-actions.png)
...
![Sync content drawer with a message summarizing what it does. At the bottom is a button which says "Sync project"](images/scripto-syncproject.png)
...
![Import content drawer with a message summarizing what it does. At the bottom is a button which says "Import project"](images/scripto-importproject.png)

### Unimport content
This option deletes all project content from Omeka S.

![Unimport content drawer with a message summarizing what it does. At the bottom is a button which says "Unimport project"](images/scripto-unimportproject.png)
...
![arrow pointing to the delete button](images/scripto-deleteProject.png)
