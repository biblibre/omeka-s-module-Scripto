...
The admin side is `youromekaurl.net/admin/scripto` and the public side is `youromekaurl.net/s/<site-slug>/scripto`.
...
From your Omeka S sites, you can create direct links to your Scripto projects using the [custom link](https://omeka.org/s/docs/user-manual/sites/site_navigation/#add-a-custom-link) in site Navigation or as a link in any [HTML page block text](https://omeka.org/s/docs/user-manual/sites/site_pages/#html).

### Scripto page block
When you add the Scripto module, it creates a new [page block](https://omeka.org/s/docs/user-manual/sites/site_pages/#page-blocks) called "Scripto"

The Scripto page block offers a drop-down to let you select from all available Scripto [projects](scriptoproject.md). Select the project you want to link from the dropdown.

![Dropdown with a single site option](images/scripto-pageBlock.png)
...
![Project browse showing three projects, only two of which have a description.](images/scripto-publicBrowse.png)
...
![Public project view. There are two large square thumbnails representing items in the project. One has a "1/3" and a full orange bar underneath it, indicating that the item is in progress](images/scripto_publicproj.png)
...
![Public item view](images/scripto_publicitem.png)
...
![media view](images/scripto_mediav.png)
...
![edit media](images/scripto_editmedia.png)
